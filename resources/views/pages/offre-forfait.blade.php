...
<section class='container'>
  <div class="container">
  <h1 class="text-center font-weight-bold">RECHARGE FORFAIT Fako</h1>
                <h5 class="text-center font-weight-bold mt-4" style='color:#f5921d'>FORFAITS JOURNALIERS</h5>
            <table class="table table-responsive-sm mt-4 mb-4">
               ...
               <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->validite}}  || {{$item->volume}}</td>
            ...
            <h5 class="text-center font-weight-bold mt-4" style='color:#f5921d'>FORFAITS HEBDOMADIARES</h5>
            <table class="table table-responsive-sm mt-4 mb-4">
                <thead>
                    <tr>
                    <th scope="col">Forfait</th>
            ...
            <h5 class="text-center font-weight-bold mt-4" style='color:#f5921d'> FORFAITS MENSUELS</h5>
            <table class="table table-responsive-sm mt-4 mb-4">
                <thead>
                    <tr>
                    <th scope="col">Forfait</th>
